...
Core Skills: ETL Pipelines, Data Cleaning, Statistical Segmentation, SQL Feature Engineering.
 ...
 1. Dynamic DashboardA filter-driven interface where users can query the database in real-time by location, cuisine, or price segment. All logic is handled via SQL WHERE and LIKE clauses to ensure high performance.
